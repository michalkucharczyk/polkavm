    ...
    G: GasVisitorT,
{
    ...
    #[inline(always)]
    fn mul256_redc256(&mut self, code_offset: u32, args_length: u32, m_d: RawReg, m_s1: RawReg, m_s2: RawReg, r_d: RawReg) -> Self::ReturnTy {
        assert_eq!(B::BITNESS, Bitness::B64);
        emit_instruction!(
            self,
            code_offset,
            args_length,
            CONTINUE_BASIC_BLOCK,
            mul256_redc256(m_d, m_s1, m_s2, r_d)
        );
    }
